...
#---------------------------------1.实体类---------------------------------
-keep class com.bitcv.sdk.Bvbean.** { *; }
-keep class com.bitcv.sdk.Bvmvp.** { *; }
-keep class com.bitcv.sdk.Bvinterfaces.** { *; }
-keep class com.bitcv.sdk.BvAche.BvSdkApplication { *; }
-keep class com.bitcv.sdk.BvAche.BvUserInfoCache { *; }
...
#下面中括号的地方需要要填你的包名
-keep public class [com.bitcv.sdk].R$*{
